...
(From W24 Midterm) Which HTTP operation model typically consumes a larger amount of **server** resources for the same web page containing many small images and js/css files: nonpersistent HTTP with parallel TCP connections or a single persistent connection with pipelining? Why?
