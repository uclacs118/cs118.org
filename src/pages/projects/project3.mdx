...
Clone the [**Starter Code**](https://github.com/uclacs118/project3s26-starter). The `helper` tools work exactly the same as Projects 0 and 2—see [**Using the Local Autograder**](/misc/autograder-p3) and [**Using the Local Autograder (…for Project 3)**](/misc/autograder-p3) for more info.
