...
After setting up your environment in [Environment Setup](/spring26/projects/environment-setup), we can now use project 0 to demonstrate how to use the local autograding harness. Make sure Docker Desktop is running (or OrbStack if on macOS). If you haven't already, clone the [Starter Code](https://github.com/uclacs118/project0s26-starter) onto your machine.
