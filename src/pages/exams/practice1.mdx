...
Suppose the network uses the Go-Back-N protocol. Node D informs A that its flow control window size is 3 packets. What is the minimum number of distinct sequence numbers that must be used?

### Packet Transport 2

Now, suppose the network uses the Selective Repeat protocol. Node D informs A that its flow control window size is 3 packets. What is the minimum number of distinct sequence numbers that must be used?
