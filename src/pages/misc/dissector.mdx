...
We've written 2 Lua script plugin for Wireshark that helps dissect packets defined in the [Project 1 spec](/projects/project1) and [Project 2 spec](/projects/project2). They are useful for:
...
1. Download the [Project 1 Lua script](/misc/dissector/w25_118_p1_protocol.lua) or the [Project 2 Lua script](/misc/dissector/w25_118_p2_protocol.lua).
2. Open Wireshark.
