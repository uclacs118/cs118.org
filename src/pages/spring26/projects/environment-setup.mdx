...
sudo ln -s $(brew --prefix)/Cellar/openssl@3/3.6.1/include/openssl /usr/local/include/
sudo ln -s $(brew --prefix)/Cellar/openssl@3/3.6.1/lib/libcrypto.a /usr/local/lib
```

Notes:
- You may have to change the version number in the commands provided above. 3.6.1 is the latest version provided by Homebrew as of April 2026.
