...
In your VSC terminal (open it up by pressing `` Ctrl + ` ``. Note that it's the
same for macOS), clone our [**Starter
Code**](https://github.com/uclacs118/project0starter) using Git. Launch the repo in a new workspace by running `code project0starter`. 
