...
The certificate contains three values: the associated DNS name (e.g. example.com), a public key, and a signature of your public key by the certificate authority. You’ll be able to access this certificate by reading the file `server_cert.bin` in the current working directory.
```
DNS-NAME-TYPE = 0xA1
